<?php
/**
 * savannatech functions and definitions
 *
 ...
 */
function savannatech_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on savannatech, use a find and replace
		* to change 'savannatech' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'savannatech', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'savannatech' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'savannatech_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'savannatech_setup' );
 ...
 */
function savannatech_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'savannatech_content_width', 640 );
}
add_action( 'after_setup_theme', 'savannatech_content_width', 0 );
 ...
 */
function savannatech_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'savannatech' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'savannatech' ),
...
add_action( 'widgets_init', 'savannatech_widgets_init' );
